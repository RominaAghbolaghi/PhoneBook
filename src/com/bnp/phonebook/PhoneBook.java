...
//        String name = scanner.nextLine();
        inputContact.name = scanner.nextLine();
//        System.out.println("Your contact's name is: " + name + "\n");
        System.out.println("Your contact's name is: " + inputContact.name + "\n");
        System.out.print(ANSI_CYAN + "Enter your contact's number: " + ANSI_RESET);
//        String number = scanner.nextLine();
        inputContact.number = scanner.nextLine();
//        System.out.println("Your contact's number is: " + number + "\n");
        System.out.println("Your contact's number is: " + inputContact.number + "\n");
